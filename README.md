...
<svg viewBox="0 0 800 200" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" style="background: #0d1117; border-radius: 8px; border: 1px solid #21262d;">
  <defs>
    ...
    <style>
      ...
      .glow-layer { transform-origin: 400px 100px; animation: pulse 3s ease-in-out infinite; }
  ...
  <g class="glow-layer">
    <circle cx="400" cy="100" r="42" fill="none" stroke="#38B2AC" stroke-width="6" opacity="0.15" />
    <circle cx="400" cy="100" r="40" fill="none" stroke="#00f2fe" stroke-width="3" opacity="0.4" />
    <circle cx="400" cy="100" r="38" fill="#0d1117" stroke="#38B2AC" stroke-width="2" />
    <text x="400" y="108" font-family="'Segoe UI', sans-serif" font-weight="900" font-size="24" fill="#00f2fe" opacity="0.3" text-anchor="middle" letter-spacing="1" style="transform: scale(1.05); transform-origin: 400px 100px;">RS</text>
    <text x="400" y="108" font-family="'Segoe UI', sans-serif" font-weight="900" font-size="24" fill="#ffffff" text-anchor="middle" letter-spacing="1">RS</text>
  </g>
...
<p align="left">
  ...
  <img src="https://img.shields.io/badge/PHP-777BB4?style=for-the-badge&logo=php&phpColor=white" alt="PHP" />
